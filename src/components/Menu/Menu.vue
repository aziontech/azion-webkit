    ...
    <ul class="flex bg-transparent p-1 gap-1 rounded-md max-h-[2.5rem] items-center">
      ...
      >
        <a
          ...
          class="p-button shadow-none p-1 px-4 p-button-text p-button-primary p-button-sm whitespace-nowrap text-white hover:surface-hover"
          :class="getBreakpointClass(menuitem)"
        >
          <span class="text-white font-sora text-sm font-normal">
            {{ menuitem.label }}
          </span>
        </a>
        ...
        >
          <button
            ...
            "
            tabindex="0"
            class="p-button shadow-none p-1 px-4 p-button-text static p-button-primary p-button-sm whitespace-nowrap transition delay-75 duration-300 bottom-6"
          ...
          <OverlayPanel
            ...
            :pt="{
              content: {
                class: `left-0 fixed top-[3.75rem] w-full hidden lg:flex flex-row rounded-md right-0 justify-start max-w-[1600px] mx-auto 3xl:max-w-[1600px] 3xl:left-1/2 transform 3xl:-translate-x-1/2`
              }
            }"
          >
            <div
              ...
              :class="[
                'flex flex-col p-4 text-black rounded-md shadow-xl transition-all duration-500 ease-out',
                menuitem.lavanderBackground ? 'bg-[#A09EBC]' : 'bg-neutral-200',
                menuitem.subMenuColumns.length === 1 ? 'ml-[31.5rem]' : menuitem.subMenuColumns.length > 2 ? 'mx-auto' : 'ml-[27.5rem]',
                  ...
                  <template v-if="subItem.length">
                    ...
                    >
                      ...
                      <template v-if="item.communityComponent">
                        ...
                        >
                        <div class=" ">
                          <a :href="communityData.href" class="flex items-center gap-3 mt-2 p-1">
