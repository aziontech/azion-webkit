<template>
  <template v-if="href || type === 'link' || type === 'linkExternal' || type === 'linkSecondary'">
    <a :href="href" :class="[
      ...
      (type === 'link' || type === 'linkExternal' || type === 'linkSecondary') && 'after:content-[\'\'] after:absolute after:-bottom-[.1rem] after:left-0 after:w-0 after:h-[1px] after:transition-all after:duration-150 hover:after:w-full',
      type === 'linkExternal' ? 'after:bg-violet-300' : type === 'linkSecondary' ? 'after:bg-neutral-300' : type === 'link' ? 'after:bg-violet-600' : ''
    ]">
      <Button
        :label="label"
        :size="size"
      ...
      <svg width="10" v-if="type === 'linkExternal' || type === 'linkSecondary' || type === 'link'" height="10" :class="['group-hover/button:translate-x-1 -translate-x-1  transition-transform relative top-[.1rem]', type === 'linkExternal' ? 'rotate-0 group-hover/button:translate-y-0 translate-y-[.1rem]' : 'rotate-45']" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
