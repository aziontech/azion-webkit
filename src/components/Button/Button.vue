...
<script setup>
  ...
  const buttonClasses = computed(() => {
    return {
      ...
      secondary: {
        dark: 'h-fit group bg-neutral-950 text-neutral-100 duration-300 transition rounded-md active:bg-neutral-900 border-1 border-neutral-900 hover:bg-transparent hover:text-orange-500',
        light:
