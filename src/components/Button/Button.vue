...
<script setup>
  ...
  const iconClasses = computed(() => {
    return {
      ...
      secondary:
        'h-fit group-hover:text-neutral-900 text-neutral-100 dark:text-neutral-100 text-[.625rem] duration-300 transition flex items-center hover:text-neutral-900 dark:group-hover:text-neutral-100 mr-2',
