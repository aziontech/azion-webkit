...
<script setup>
  ...
  const buttonClasses = computed(() => {
    return {
      primary: {
        dark: 'h-fit group border-1 border-neutral-900 active:bg-orange-700 bg-neutral-900 text-neutral-100 duration-300 transition px-3 py-3 rounded-md hover:bg-orange-500 hover:border-orange-500 hover:text-neutral-900',
        light:
      ...
      secondary: {
        dark: 'h-fit group bg-neutral-950 text-neutral-100 duration-300 transition px-3 py-3 rounded-md active:bg-neutral-900 border-1 border-neutral-900 hover:bg-transparent hover:text-orange-500',
        light:
          'h-fit group bg-neutral-200 text-neutral-900 duration-300 transition px-3 py-3 rounded-md active:bg-neutral-700 border-1 border-neutral-400 hover:bg-neutral-100 hover:text-orange-500 hover:border-neutral-300'
      },
      tertiary: {
