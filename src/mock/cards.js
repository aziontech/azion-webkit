export default [
  ...
  },
  {
    ...
    description:
      'To fully harness the power of edge computing, edge-native applications must be capable of executing serverless compute logic when and where they’re needed.',
  ...
  },
  {
    ...
    description:
      'After a long period of uncertainty, caused by the COVID-19 pandemic, e-commerces are facing new challenges such as the exponential increase in online business, higher advertising costs, improving user experience, and threats to the security of your applications.',
  ...
  },
  {
    ...
    description:
      "An introduction to data streaming and analytics enablement, touching on the principles of monitoring and observability and showcasing Azion's suite of analytics tools.",
  ...
  },
  {
    ...
    description:
      'Load balancing is the process of distributing tasks over a set of resources that allows solving network traffic problems.',
