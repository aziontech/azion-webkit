...
export default {
  title: '1. Blocks/Forms/Be Partner',
  component: BePartner,
  tags: ['autodocs'],
  argTypes: {
    t: {
...
const props = {
  ...
  "t": {
    ...
    "azionPrivacy": {
      "description": "Azion respeta tu privacidad y utiliza tu información personal solo para proveer y comunicar sobre productos y servicios. Puedes optar por no recibir nuestras comunicaciones en cualquier momento. Para obtener más información, consulta nuestra ",
