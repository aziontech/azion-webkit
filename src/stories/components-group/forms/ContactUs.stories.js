...
export default {
  title: 'Components Group/Forms/Contact Us',
  component: BePartner,
  tags: ['autodocs'],
  argTypes: {
    t: {
...
const props = {
  ...
  t: {
    ...
    azionPrivacy: {
      description:
        'Azion respects your privacy and uses your personal information only to provide and communicate about products and services. You can opt out of receiving our communications at any time. To learn more, check our',
