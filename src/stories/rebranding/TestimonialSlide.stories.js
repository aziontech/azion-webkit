...
export default {
  title: 'Components/Rebranding/TestimonialSlide',
  ...
  parameters: {
    docs: {
      description: {
        component: `
The TestimonialSlide component displays a collection of testimonials in a carousel format using Swiper. Each testimonial includes a logo, testimonial text, and source attribution.

### Features
- Swiper carousel layout with grab cursor for smooth navigation
- Autoplay functionality with 3-second intervals
...
const Template = (args) => ({
  ...
  template: `<TestimonialSlide v-bind="args" class="p-6 bg-black" />`
})
...
export const GartnerTestimonial = Template.bind({})
GartnerTestimonial.args = {
...
MultipleSources.args = {
  items: mockTestimonials.slice(0, 4),
  title: 'INDUSTRY VALIDATION',
  button: {
    label: 'See All Awards',
    link: '/awards'
  }
}
