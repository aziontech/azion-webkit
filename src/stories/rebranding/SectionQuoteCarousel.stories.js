...
const Template = (args) => ({
  ...
  template: `<SectionQuoteCarousel v-bind="args" class="p-6 bg-black" />`
})
...
export const SingleQuote = Template.bind({})
SingleQuote.args = {
  items: [mockQuotes[0]]
}

export const TwoQuotes = Template.bind({})
TwoQuotes.args = {
  items: mockQuotes.slice(0, 2)
}

export const MultipleQuotes = Template.bind({})
MultipleQuotes.args = {
  items: [...mockQuotes, ...mockQuotes]
}
