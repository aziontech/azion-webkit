...
import SectionGridHighlight from '../../../templates/sectiongridhighlight'
import Rules from '../../rules'

export default {
  title: 'Blocks/Sections/section-grid-highlight',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
  ...
  return {
    ...
    template: `
      <Container class="surface-ground">
        <SectionGridHighlight v-bind="args" />
      </Container>
    `
  }
}
  ...
  cards: [
    {
      image: logoSvg,
      alt: 'Logo Renner',
      link: 'https://www.azion.com/pt-br/casos-de-sucesso/renner/',
      description:
