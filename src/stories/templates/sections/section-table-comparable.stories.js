...
Default.args = {
  ...
  description:
    'Our platform and flexible service levels make it easy for businesses of all sizes to choose the option that best fits their needs.',
  tableHead: {
    title: 'Compare Plans',
    description:
      "Find the perfect plan for your company's needs by exploring our flexible options designed to fit businesses of all sizes."
  },
  cards: {
    developer: {
      title: 'Developer',
      cost: 'Free Trial',
      description:
        'If you want to explore the potential of our platform yourself, we recommend the Developer Plan',
      button: {
    ...
    business: {
      ...
      cost: '$100/mo',
      description:
        'For customers seeking efficient and accessible technological solutions, we recommend the Business Plan.',
      button: {
    ...
    enterprise: {
      ...
      cost: '$3.500/mo',
      description:
        'For customers with critical operations and systems, we recommend the Enterprise Plan.',
      button: {
        link: 'https://www.azion.com/en/contact-sales/',
    ...
    missionCritical: {
      ...
      cost: 'Custom',
      description:
        'For customers whose online presence is critical and service performance directly impacts business results, we recommend the Mission Critical Plan.',
      button: {
        link: 'https://www.azion.com/en/contact-sales/',
  ...
  tablesId: ['product', 'developer', 'business', 'enterprise', 'missionCritical'],
  tables: [
    {
      product: {
    ...
    },
    {
      ...
      business: {
        label:
          'Question: <24h <br />Issue: <12h<br />Major Issue: <4h<br />Outage: <2h<br />Critical Outage: N/A'
      },
      enterprise: {
        label:
          'Question: <24h<br />Issue: <12h<br />Major Issue: <4h<br />Outage: <1h<br />Critical Outage: <15min'
      },
      missionCritical: {
        label:
          'Question: <12h<br />Issue: <12h<br />Major Issue: <2h<br />Outage: <30min<br />Critical Outage: <15min'
      }
    },
    {
      product: {
