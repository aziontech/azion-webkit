...
const MOCK = {
  ...
  description:
    'Tornamos as aplicações mais rápidas e confiáveis. Faça o deploy de seus projetos instantaneamente na rede global mais confiável, proteja suas aplicações com segurança avançada.',
  buttons: [
    {
      label: 'Start Now',
