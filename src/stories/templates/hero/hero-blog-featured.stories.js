...
const MOCK = {
  ...
  cards: {
    data: [
      ...
      {
        tagList: ['Developers', 'Caching'],
        title: 'Implement a Tiered Cache and Reduce Costs for Your E-commerce',
        description:
          'Optimize e-commerce with Edge Computing: Enhance performance and scalability by implementing an efficient Tiered Cache strategy with Azion Edge Application.',
        link: '/en/blog/implement-tiered-cache/',
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/transformtheonlineshopping_2022_blogpost_v2.png',
        authors: [
          {
      ...
      },
      {
        ...
        description:
          "Explore how Azion's Edge Runtime and Vulcan enhance web development by enabling frameworks to run natively at the edge, optimizing speed and security.",
        link: '/en/blog/effortless-edge-deployment-with-vulcan/',
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/azion-cells-technical-approach-and-the-future-of-serverless-computing.png',
        authors: [
          {
            avatar: 'https://www.azion.com/assets/blog/images/uploads/image-1-1.png',
            title: 'Gabriel França',
      ...
      },
      {
        ...
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/thumbnailblog-codeeditor-chatgpt-440x343px.png',
        authors: [
          {
      ...
      {
        tagList: ['Company News', 'Developers'],
        title: 'Supercharge Your Content Delivery Strategy With These Azion Templates',
        description:
          "Discover top-notch templates for Edge Applications to enhance content delivery, reduce latency, and optimize user experience with Azion's robust Edge Computing platform.",
        ...
        authors: [
          {
            avatar:
              'https://www.azion.com/assets/blog/images/uploads/whatsapp-image-2021-12-08-at-16-22-01.jpeg',
            title: 'Thiago Silva',
      ...
      },
      {
        ...
        description:
          "Explore how Azion's Web Application Firewall (WAF) fosters cybersecurity in diverse sectors, optimizes digital transformation, and uses edge computing for swift, efficient security solutions.",
      ...
      },
      {
        ...
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/thumbblog-whatiswaf-440x343px-1.png',
        authors: [
          {
      ...
      },
      {
        ...
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/thumbnailblog-4templatesimproveexperience-440x343px-1.png',
        authors: [
          {
            avatar:
              'https://www.azion.com/assets/blog/images/uploads/whatsapp-image-2021-12-08-at-16-22-01.jpeg',
      ...
      {
        tagList: ['Security', 'Market Trends'],
        title: 'Five Ways HTTP/3 Can Increase the Security of Your Applications',
        description:
          'Explore how HTTP/3 ensures web security with TLS 1.3 encryption, QUIC protocol, and IP spoofing prevention, enhancing performance for web applications.',
      ...
      {
        tagList: ['Observability', 'Security', 'Company News'],
        title:
          'Enhance the security of your applications with the new Fingerprint feature of the Azion Marketplace',
        description:
          'Explore Azion Fingerprint for enhanced application security and device identification. Secure, scalable, and quick to implement.',
        link: '/en/blog/enhance-security-azion-fingerprint/',
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/thumbnailblog-fingerprint-v2-440x343px.png',
        authors: [
          {
            avatar:
              'https://www.azion.com/assets/blog/images/uploads/whatsapp-image-2021-12-08-at-16-22-01.jpeg',
      ...
      },
      {
        ...
        description:
          'Explore how Azion WAF ensures advanced cybersecurity against evolving threats with flexible rules and minimal operational complexity.',
        link: '/en/blog/why-waf-essential-cybersecurity/',
        linkTarget: '_self',
        image:
          'https://www.azion.com/assets/blog/images/uploads/thumbblog-why-choose-the-azion-waf.png',
        authors: [
          {
            avatar: 'https://www.azion.com/assets/blog/images/uploads/retrato_branco_quadrado.png',
            title: 'Rafael Rigues',
