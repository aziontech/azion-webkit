    ...
    <div class="container mx-auto">
      <div class="lg:py-28 py-8">
        <div class="lg:flex justify-between lg:gap-4">
          ...
          <div class="lg:w-2/4">
            <form :id="formIdElement" :name="formIdElement" class="mt-8">

              <InputText class='min-w-full' :placeholder="props.placeholderInput" />
              <div class="flex lg:gap-4 mt-4 gap-2">
                <InputText type="e-mail" class='w-1/2' :placeholder="props.placeholderEmail" />
                <Button icon="pi pi-chevron-right" iconPos="right" type="submit" class="w-1/2" :label="buttonText"
                  size="small" />
              </div>
            </form>
          </div>
