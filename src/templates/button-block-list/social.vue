<template>
  <div class="flex gap-2">
    ...
    <a href="https://www.linkedin.com/company/aziontech/" target="_blank" rel="noopener noreferrer" class="p-button p-component p-button-icon-only p-button-text p-button-sm no-underline">
