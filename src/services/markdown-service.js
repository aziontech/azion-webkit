export const parseMarkdown = (markdown) => {
  ...
  text = text
    .replace(/<Button\s+href="([^"]+)"[^>]*type="primary"[^>]*>([^<]+)<\/Button>/gi, '<a href="$1" class="group flex w-fit items-center font-proto-mono uppercase border-none active:bg-orange-600 bg-neutral-100 text-neutral-900 duration-300 transition px-5 md:px-6  rounded-md hover:bg-orange-600 hover:text-white h-[42px] min-h-[42px] py-3 font-proto-mono text-sm leading-[2rem] whitespace-nowrap  cursor-pointer">$2</a>')
  ...
  text = text
    .replace(/<Button\s+href="([^"]+)"[^>]*type="secondary"[^>]*>([^<]+)<\/Button>/gi, '<a href="$1" class="group flex w-fit items-center bg-neutral-950 h-[2.5rem] text-neutral-100 duration-300 transition rounded-md active:bg-neutral-900 border-1 border-[#353040] hover:bg-neutral-900 hover:text-orange-500 px-5 md:px-6 font-proto-mono text-sm leading-[2.5rem] whitespace-nowrap cursor-pointer">$2</a>')
