export const parseMarkdown = (markdown) => {
  ...
  text = text
    .replace(/<Button\s+href="([^"]+)"[^>]*type="secondary"[^>]*>([^<]+)<\/Button>/gi, '<a href="$1" class="group items-center bg-neutral-950 h-[2.5rem] text-neutral-100 duration-300 transition rounded-md active:bg-neutral-900 border-1 border-[#353040] hover:bg-neutral-900 hover:text-orange-500 px-5 md:px-6 font-proto-mono text-sm leading-[2.5rem] whitespace-nowrap inline-block cursor-pointer">$2</a>')
