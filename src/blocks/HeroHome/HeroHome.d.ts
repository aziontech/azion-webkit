 ...
 *
 * @module `blocks/HeroHome`
 * @version 2.0.0 - Migrated from LinkButton to Button component, moved to blocks structure
 */
 ...
 * @version 2.0.0 - Updated to support new Button component, moved to blocks structure
 */
