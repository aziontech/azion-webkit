...
<template>
  <div class="flex flex-col gap-1.5">
    ...
    <select
      ...
      class="w-full py-2 pl-3 pr-8 text-sm text-base bg-layer1 hover:bg-layer1-hover border border-base rounded-md cursor-pointer transition-[border-color,box-shadow] duration-150 focus:outline-none focus:border-blue-500 focus:ring-3 focus:ring-blue-500/10 appearance-none bg-no-repeat bg-[length:1.5em_1.5em] bg-[right_0.5rem_center]"
